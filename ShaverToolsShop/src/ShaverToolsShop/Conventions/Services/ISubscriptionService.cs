...
namespace ShaverToolsShop.Conventions.Services
{
    ...
    {
        Task<List<Subscription>> GetAllWithProductsWithNotExpiredDate(DateTime todayDate);
        ...
        Task<CommandResult> UpdateSubscription(Guid subscriptionId, Subscription subscription);
    }
}